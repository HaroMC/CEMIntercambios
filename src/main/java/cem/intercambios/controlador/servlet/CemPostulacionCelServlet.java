 ...
 * @author Bugueño
 */
public class CemPostulacionCelServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String mensaje;
        List<InscripcionCel> listadoPostulacionesCel = icf.findAll();
        if (listadoPostulacionesCel != null) {
            
            sesion.setAttribute("listadoPostulacionesCel", listadoPostulacionesCel);
        ...
        response.sendRedirect("administrar-postulaciones-cels.jsp");
