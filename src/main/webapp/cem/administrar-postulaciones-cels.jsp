<%-- 
    Document   : administrar-postulaciones-cels
    Created on : 04-12-2017, 0:25:31
    Author     : Bugueño
--%>
...
<html>
    ...
    <body>
        <div class="container">
            <h2> Listado de Cel's postulantes a programas</h2>
            <p>
            ...
            <table class="table table-bordered table-striped">
                ...
                <tbody id="myTable2">
                    <c:forEach var="p" items="${listadoPostulacionesCel}" >
                        <tr>
